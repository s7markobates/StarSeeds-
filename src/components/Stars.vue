<template>
    <div>
        ...
        <div>
            ...
            <i class="far fa-circle absolute text-white opacity-30 text-[25px] sm:text-[45px] top-[100px] right-[140px] z-[1]"></i>
        </div>

        <!-- People -->
        <div>
            <i title="Hello friend!" class="fas fa-street-view text-gray-100 text-[25px] hover:text-[35px] opacity-90 absolute bottom-[130px] left-[160px] md:left-[320px] hover:-ml-[5px] duration-200 hover:cursor-none  z-[3]" ></i>
            <i title="Welcome to StarSeeds" class="fas fa-street-view text-yellow-600 text-[25px] hover:text-[35px] opacity-90 absolute bottom-[155px] left-[230px] md:left-[430px] hover:-ml-[5px] duration-200 hover:cursor-none  z-[3]"></i>
            <i title="You'll love it here! :)" class="fas fa-street-view text-red-700 text-[25px] hover:text-[35px] opacity-90 absolute bottom-[100px] left-[320px] md:left-[460px] hover:-ml-[5px] duration-200 hover:cursor-none z-[3]"></i>
            <i title="Namaste" class="fas fa-street-view text-amber-900 text-[25px] hover:text-[35px] opacity-90 absolute bottom-[130px] md:bottom-[40px] left-[45px] md:left-[570px] hover:-ml-[5px] duration-200 hover:cursor-none z-[3]"></i>
            <i title="Hakuna Matata" class="fas fa-street-view text-gray-800 text-[25px] hover:text-[35px]  opacity-90 absolute bottom-[20px] md:bottom-[150px] left-[400px] md:left-[220px] hover:-ml-[5px] duration-200 hover:cursor-none z-[3]"></i>
        </div>
        ...
        <!-- Stars -->
        <div>
            <i class="fas fa-sun fa-spin text-orange-500 text-[17px] opacity-80 absolute top-[100px] right-[65px] hover:text-yellow-500"></i>
            ...
            <i class="fas fa-sun fa-spin text-yellow-500 text-[16px] opacity-80 absolute top-[150px] right-[300px]"></i>
            <i class="fas fa-sun fa-spin text-yellow-500 text-[18px] absolute top-[150px] md:top-[300px] right-[80px] md:right-[140px]"></i>
            <i class="fas fa-sun fa-spin text-yellow-500 text-[10px] opacity-80 absolute top-[380px] right-[50px] md:right-[120px]"></i>
            <i class="fas fa-sun fa-spin text-yellow-500 text-[8px] opacity-90 absolute top-[70px] left-[250px]"></i>
