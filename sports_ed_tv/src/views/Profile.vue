<template>
  ...
  <div class="w-[95%] mx-auto my-3 bg-gray-200 px-4 py-3 rounded-lg shadow-md">
    <div class="flex justify-between items-end">
      <div>
        ...
        <img :src="profile.image" class="h-32 w-32 rounded-full shadow-2xl border-2 border-gray-300 mx-5 -mt-16" alt="Profile Image" />
      </div>
